import '../../../css/principal_admin/central_admin/administrar_usuarios/editar_cliente.css';
import { useState, useEffect } from "react";
import Eliminar_usuario from "./Eliminar_usuario";



const Editar_cliente = ({editCliente, cerrar_editar_cliente})=>{
...
const handleEliminarUsuario = async () =>{
  ...
  try{
    ...
    return (
<>
    <div className="principal_editar_cliente">
      ...
      <div className="editar_usuario">
        ...
        <button className="cerrar_editar" onClick={cerrar_editar_cliente}>Cerrar</button>
