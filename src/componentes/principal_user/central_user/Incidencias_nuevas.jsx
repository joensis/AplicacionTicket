import '../../../css/principal_user/central_user/incidencias_nuevas.css'
import { useState, useEffect } from 'react';
import Desplegar_incidencia from '../../principal_admin/central_admin/incidencias/Desplegar_incidencias';

const Incidencias_nuevas = ({id_user, usuario, url_php})=>{
    ...
    return (
        ...
        <div className="incidencias_nuevas">
            ...
            <p id='incidencias_nuevas'>Nuevas incidencias</p>
...
export default Incidencias_nuevas;